...
class App extends React.Component {
    ...
    handleChange = key => (event, value) => {
        this.setState({[key]: value, display: 'hidden'});
    ...
    componentDidMount() {
        this.setState({ancestor: document.getElementsByName('ancestor'), parent: document.getElementById('parent').getBoundingClientRect(), self: document.getElementById('self')});
    }
    ...
    render() {
        ...
        return (
            <div>
                <CodeAddr addr="Bubble/Bubble.jsx"/>
                <Grid container spacing={16}>
                    <Grid item xs={12} sm={6}>
                        <FormControl component="fieldset">
                            <FormLabel component="legend">Arrow Direction</FormLabel>
                            <RadioGroup aria-label="arrowDirection" name="arrowDirection" value={this.state.arrowOriginalDirection} onChange={this.handleChange('arrowOriginalDirection')}>
                    ...
                    <Grid item xs={12} sm={6}>
                        <FormControl component="fieldset">
                            ...
                            <RadioGroup id="floated" aria-label="floated" name="floated" value={this.state.floatOriginal} onChange={this.handleChange('floatOriginal')}>
                ...
                <div name="ancestor">
                    ...
                    <div style={{
                        ...
                        <div id="self">
                            <Bubble parent={this.state.parent} self={this.state.self} ancestor={this.state.ancestor} direction={this.state.arrowOriginalDirection} floated={this.state.floatOriginal} triSize="12" bgColor="cyan" classes={{
