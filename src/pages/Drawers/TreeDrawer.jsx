...
import { Drawer, AppBar,Toolbar, Typography, Divider, SvgIcon }  from '@material-ui/core';
...
class MiniDrawer extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
      <CodeAddr addr="Drawers/TreeDrawer.jsx"/>
        <Usage>
            {`
//first: installation
npm install rc-menu --save   (Navbar中依賴的包)
npm install react-custom-scrollbars --save  (Scrollbar中依賴的包)
