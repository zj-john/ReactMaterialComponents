...
class BackTop extends React.Component {
  ...
  resetPosition() {
    ...
    if (customButton) {
      let customWith = customButton.getBoundingClientRect().width; // 自定义按钮本身的宽度
      let customHeight = customButton.getBoundingClientRect().height; // 自定义按钮本身的高度
      if (customWith > 40) {
        customWith = 40;
      }
      if (customHeight > 40) {
